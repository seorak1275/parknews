...
const SETS = {
  kr: {
    ...
    queries: [
      ...
      '국립공원 예산', '국립공원 케이블카', '국립공원 산불', '국립공원 야영장',
      '국립공원 복원', '국립공원 훼손',
      /* 개별 공원 24곳 — 한 곳이라도 빠지면 그 공원 기사는 대표 질의에만 의존한다 */
      '설악산 국립공원', '지리산 국립공원', '한라산 국립공원', '북한산 국립공원',
      '내장산 국립공원', '태백산 국립공원', '다도해해상 국립공원', '무등산 국립공원',
      '가야산 국립공원', '소백산 국립공원', '주왕산 국립공원', '팔공산 국립공원',
      '경주 국립공원', '계룡산 국립공원', '한려해상 국립공원', '속리산 국립공원',
      '덕유산 국립공원', '오대산 국립공원', '태안해안 국립공원', '치악산 국립공원',
      '월악산 국립공원', '변산반도 국립공원', '월출산 국립공원', '금정산 국립공원',
      /* 참고기사(기후·산림·관광) 후보 */
 ...
 *  4. 기간 집계
 * ======================================================== */
const TOP_PER_DAY = 80;     // 하루치에 보관할 상위 사안 수 — 40이면 단독 보도가 잘려 공원별 기간 순위가 굶는다(2026-08-22)
