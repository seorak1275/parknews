...
SUBSECTORS = {
    ...
    "재난안전": [
        ("물놀이 위험지역", ["물놀이 위험지역", "물놀이 안전", "물놀이", "수상안전",
                          "안전관리요원", "위험지역 지정"]),
        ("산불", ["산불", "화재", "진화", "발화", "잔불"]),
    ...
    "자원보전": [
        ("불법·무질서 단속", ["불법행위", "무질서행위", "불법채취", "불법취사", "불법야영",
                          "밀렵", "밀거래", "샛길", "비법정탐방로", "집중단속", "특별단속",
                          "과태료", "무단출입", "오물투기", "단속"]),
